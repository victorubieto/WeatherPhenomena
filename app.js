...
import { basic_vs, flat_fs } from './shaderAtlas.js';
...
class App {
    ...
    initScene() {
        ...
        let viewport_plane = new THREE.Mesh( new THREE.PlaneGeometry( 1, 1 ), custom_mat );
        viewport_plane.position.set( 0, 1, 1 ); // change to camera position
        this.scene.add( viewport_plane );
    ...
    initSky() {
        ...
        let gui = new GUI(); // remove
        let day = gui.addFolder('Daylight');
    ...
    initGUI() {
        ...
        let gui = new GUI().title('Weather Phenomena Controls');
